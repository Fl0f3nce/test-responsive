...
<%-- component: menu --%>
<ielm:Menubar>
  <ielm:Menu id="simulation-menu-1_scenario" title="Szenario">
    <ielm:Menuitem id="simulation-menu-1_scenario_open" name="Szenario laden"/>
    <ielm:Menuitem id="simulation-menu-1_scenario_one" name="Szenario 1" />
    <ielm:Menuitem id="simulation-menu-1_scenario_two" name="Szenario 2" />
  </ielm:Menu>

  <ielm:Menu id="simulation-menu-1_parameter" title="Parameter">
    <ielm:Menuitem id="simulation-menu-1_parameter_one" name="Parameter 1" />
    <ielm:Menuitem id="simulation-menu-1_parameter_two" name="Parameter 2" />
    <ielm:Menuitem id="simulation-menu-1_parameter_three" name="Parameter 3" />
    <ielm:Menuitem>
      <select id="simulation-menu-1_parameter_three_selection">
