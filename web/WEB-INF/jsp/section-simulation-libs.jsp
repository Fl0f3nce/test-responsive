...
<%
  ...
  if (commonpath == null)
  {
    ...
    out.println("<script>"
            ...
            + "window.console.log('section-simulation-libs.jsp:: Context-Parameter: " + contextparam + " not found. Using default value "
            + commonpath + "') }"
            + "</script>");
  }
%>
...
<link rel="stylesheet" type="text/css" href="<%=web_application%><%=commonpath%>ielm-components/menu/simulation-menu-1.css" />
